...
def debug_blocker(ltable, rtable, candidate_set, use_plain, output_path, output_size=200,
    ...
    lrecord_token_list, lrecord_index_list = split_record_token_and_index(lrecord_list)
    rrecord_token_list, rrecord_index_list = split_record_token_and_index(rrecord_list)
    ...
    debugblocker_cython(lrecord_token_list, rrecord_token_list,
                        ...
                        new_formatted_candidate_set, len(feature_list), output_size, output_path, use_plain)
...
def split_record_token_and_index(record_list):
    record_token_list = []
    record_index_list = []
    for i in range(len(record_list)):
        token_list = []
